    ...
    <div class="row">
        <div class="col-md-12 text-right">
            <div style="padding:20px 0;">
                <a href="orders/create" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-plus-sign"></i> Add New</a>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <section class="module">
                ...
                <div class="module-body">
                    {{ Datatable::table()
                    ->addColumn(Utility::orderAllowedCol($userType=1)) // these are the column headings to be shown
