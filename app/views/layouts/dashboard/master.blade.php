...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('bower_components/bootstrap/dist/css/datepicker3.css') }}"/>
    ...
    <script src="{{ asset('bower_components/bootstrap/dist/js/bootstrap-datepicker.js') }}"></script>
