        ...
        <div class="row">
            <div class="col-md-12 text-right">
                <div style="padding:20px 0;">
                    <a href="{{URL::route('CreateQc')}}" class="btn btn-danger btn-sm"><i
        ...
        <div class="row">
            <div class="col-md-12 writerDataTable">
                <section class="module">
                    <div class="module-head"><b><strong><i class="glyphicon glyphicon-user"></i> All Quality Controllers</strong></b>
                    </div>
